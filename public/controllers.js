app.controller('HomeController', function($scope, $http, $routeParams, JsonService){
  ...
  // $scope.items = $resource('items.json');
  // $scope.items = $resource('items.json',{ }, {
  ...
  $scope.removeItem = function(index){
    var indexIt = $scope.shoppingCart.indexOf(index);
    $scope.shoppingCart.splice(indexIt, 1);
  }
